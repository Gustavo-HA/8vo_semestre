...
! costo, area =800, cercos de un lado = 5pesos/m, cercos del otro = 4pesos/m, tal que 
! L_1*L_2 = 800
! El costo está dado por: 5*L_1 + 4*L_2
! Entonces costo = 5*L_1 + 4*800/L_1
